@extends('layouts.admin')
        @section('content')
            ...
            <div class="crumb_warp">
                ...
                <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="#">生产物料清单</a> &raquo; 添加
            </div>
            <!--面包屑导航 结束-->
            ...
            <div class="result_wrap">
                    ...
                    <table class="add_tab">
                        ...
                        <tr>
                            <th>选择物料：</th>
                            <td>
                                <input type='text' list="plist" id="Pd_Code" AUTOCOMPLETE="off"   onkeyup="select_pcode(event,this.value);get_pinfo(this.value)" onchange="get_pinfo(this.value)" name="Pd_Code">
                        ...
                        <tr>
                            <th>出成率：</th>
                            <td>
                                <input type="text" AUTOCOMPLETE="off"   name="Pb_Per" id="Pb_Per" onkeyup="checkFloat(this)" onblur="fomatFloat(this,4)" >
                            </td>
                        </tr>
