@extends('layouts.admin')
        @section('content')
            ...
            <div class="result_wrap">
                <form action="{{url('admin/dict')}}" method="post">
                    {{csrf_field()}}
                    <table class="add_tab">
                        <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tc" value="" name="dic_cat">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tc" value="" name="dic_cat_name">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tc" value=""  name="dic_item_code">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="tc" value="" name="dic_item_name">
                        ...
                        <tr>
                            <th>排序：</th>
                            <td>
                                <input type="text" class="sm" name="dic_order">
