@extends('layouts.admin')
        @section('content')
            ...
            <div class="crumb_warp">
                ...
                <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">设备管理</a> &raquo; 修改信息
            </div>
            <!--面包屑导航 结束-->
            ...
            <div class="result_wrap">
                <form action="{{url('admin/device/'.$field->id)}}" method="post">
                    ...
                    <table class="add_tab">
                            ...
                            <td>
                                <select name="vender" id="vender">
                                    ...
                                    @foreach($vender_info as $v)
                                        @if($field->vender == $v->cust_nameCn)
                                            <option value="{{$v->cust_nameCn}}" onclick="putinfo('{{$v->cust_LinkMan}}','{{$v->cust_tel}}')" selected>{{$v->cust_nameCn}}</option>
                                        @else
                        ...
                        <tr>
                            <th>联系人：</th>
                            <td>
                                <input type="text" readonly name="contactman" id="contactman" value="{{$field->contactman}}">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" readonly name="contactphone" id="contactphone" value="{{$field->contactphone}}" >
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="device_code"  value="{{$field->device_code}}">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require">*</i>设备名称：</th>
                            <td>
                                <input type="text" name="device_name" value="{{$field->device_name}}">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require">*</i>技术文档编号：</th>
                            <td>
                                <input type="text" name="tech_code" value="{{$field->tech_code}}">
                            </td>
                        </tr>
