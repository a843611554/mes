...
(function( root, factory ) {
    ...
    define('lib/filepicker',[
        ...
        Base.inherits( RuntimeClent, {
            ...
            init: function() {
                ...
                button.addClass('webuploader-custompackage');
                ...
                me.on( 'all', function( type ) {
                    ...
                    switch ( type ) {
                        case 'mouseenter':
                            button.addClass('webuploader-custompackage-hover');
                            break;
    
                        case 'mouseleave':
                            button.removeClass('webuploader-custompackage-hover');
                            break;
            ...
            enable: function() {
                ...
                btn.removeClass('webuploader-custompackage-disable');
                this.refresh();
            },
            ...
            disable: function() {
                ...
                btn.addClass('webuploader-custompackage-disable');
            },
    ...
    define('widgets/filepicker',[
        ...
        $.extend( Uploader.options, {
            ...
            /**
             * @property {Selector | Object} [custompackage=undefined]
             * @namespace options
             * @for Uploader
        ...
        return Uploader.register({
             ...
             * @method addButton
             * @for Uploader
             * @grammar addButton( custompackage ) => Promise
             * @description
             * 添加文件选择按钮，如果一个按钮不够，需要调用此方法来添加。参数跟[options.custompackage](#WebUploader:Uploader:options)一致。
             * @example
             * uploader.addButton({
             *     id: '#btnContainer',
             *     innerHTML: '选择文件'
